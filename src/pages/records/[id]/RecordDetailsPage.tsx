...
const RecordDetailsPage = () => {
    ...
    const [record, getRecordById, updateRecord] = useUnit(
        [
            tableModel.$record,
            tableModel.getRecordById,
    ...
    const handleUpdate = (updatedRecord: TableType) => {
        const tags = typeof updatedRecord.tags === 'string' ? updatedRecord.tags.split(',').map(tag => tag.trim()) : [];
        const updated = {
            ...record,
            ...updatedRecord,
    ...
    return (
        <div>
            ...
            <Form form={form} layout="vertical" name="form_in_modal" onFinish={handleUpdate}>
                <Form.Item
                    name="name"
                    label="Name"
